...
Another change is that all modules have a :attr:`~module.__loader__` attribute,
storing the
...
Loaders are also now expected to set the :attr:`~module.__package__` attribute from
