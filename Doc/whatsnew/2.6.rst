...
When you run Python, the module search path :data:`sys.path` usually
...
Python programs as the :data:`sys.dont_write_bytecode` variable, and
...
* A new variable in the :mod:`sys` module, :attr:`float_info`, is an
  ...
  tuple available as :data:`sys.flags`.  For example, the :attr:`~sys.flags.verbose`
  attribute is true if Python
  was executed in verbose mode, :attr:`~sys.flags.debug` is true in
  debugging mode, etc.
...
* Importing modules simultaneously in two different threads no longer
  ...
  module in :data:`sys.modules` first, then try to import it after
