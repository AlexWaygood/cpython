...
Built-in :func:`breakpoint` calls :func:`sys.breakpointhook`.  By default, the
latter imports :mod:`pdb` and then calls :func:`pdb.set_trace`, but by binding
:func:`sys.breakpointhook` to the function of your choosing,
:func:`!breakpoint` can
...
* When using the :option:`-m` switch, :data:`sys.path[0] <sys.path>` is now
  eagerly expanded
...
The undocumented :func:`sys.callstats` function has been deprecated and
